# -*- coding: utf-8 -*-
"""
Created on Sun Oct 15 22:56:45 2017
...
if __name__ == '__main__':
    ...
    print "Top 10 contributing users: " , top_contributing_users()
    print "Number of users contributing only once: " , number_of_users_contributing_once()
    print "Biggest religion: " , biggest_religion()
    print "Popular cuisines: " , popular_cuisines()
    print "Common roadtypes: " , common_roadtypes()